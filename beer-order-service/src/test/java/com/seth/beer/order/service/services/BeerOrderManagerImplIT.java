...
import com.seth.beer.order.service.domain.BeerOrderLine;
...
public class BeerOrderManagerImplIT {
    ...
    void testAllocatedToCancel() throws JsonProcessingException {
        ...
        DeallocateOrderEvent deallocateOrderRequest = (DeallocateOrderEvent) jmsTemplate.receiveAndConvert(JmsConfig.DEALLOCATE_ORDER_QUEUE);
